...
import {GithubLinker} from "./GitHubAnalyzer/GitHubLinker";

console.log("Starting GitHub data analysis...\n");

const FILENAME = "githubProject.json"; // Input file from your GitHub data export
const linker: GithubLinker = new GithubLinker();

(async () => {
    try {
        // Read and analyze GitHub data
        await linker.parseFile(FILENAME);
        console.log("✅ GitHub data analysis completed successfully!\n");
    } catch (error) {
